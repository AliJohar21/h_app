...
import 'create_log_in_model.dart';
export 'create_log_in_model.dart';

class CreateLogInWidget extends StatefulWidget {
  const CreateLogInWidget({super.key});
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '4xly87bh' /* Let's get started by filling o... */,
                                            ),
                                            textAlign: TextAlign.start,
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .universityTextController,
                                              focusNode:
                                                  _model.universityFocusNode,
                                              autofocus: true,
                                              autofillHints: [
                                                AutofillHints.email
                                              ],
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.programTextController,
                                              focusNode:
                                                  _model.programFocusNode,
                                              autofocus: true,
                                              autofillHints: [
                                                AutofillHints.email
                                              ],
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.reqhoursTextController,
                                              focusNode:
                                                  _model.reqhoursFocusNode,
                                              autofocus: true,
                                              autofillHints: [
                                                AutofillHints.email
                                              ],
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '6hq9jdu2' /* Internship Start Date */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelLarge
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                ...
                                                await UDetailsRecord.collection
                                                    .doc(currentUserUid)
                                                    .set(
                                                        createUDetailsRecordData(
                                                      fname: _model
                                                          .firstNameTextController
                                                          .text,
                                                      lname: _model
                                                      ...
                                                      university: _model
                                                          ...
                                                          .text,
                                                      major: _model
                                                          .programTextController
                                                          .text,
                                                      reqhours: int.tryParse(_model
                                                          .reqhoursTextController
                                                          .text),
                                                      startdate: _model
                                                          .startDateTextController
                                                          .text,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'odan1a1u' /* Fill out the information below... */,
                                            ),
                                            textAlign: TextAlign.start,
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
